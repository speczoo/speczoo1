...
<div id="container">
    ...
    <div id="showDataDiv">
        ...
        <div id="addUser">
            <sf:form method="post" modelAttribute="userDto" action="user/create">
                <table cellspacing="0" cellPadding="0">
                    ...
                    <tr>
                        ...
                        <td class="leftTd"><sf:input path="username" size="30" id="username"/>
                    ...
                    <tr>
                        ...
                        <td><input type="password" id="confirmPwd" name="confirmPwd" size="30" showPassword='true'/></td>
                    </tr>
                    <tr>
