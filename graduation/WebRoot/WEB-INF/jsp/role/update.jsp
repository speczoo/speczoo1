...
<div id="container">
    ...
    <div id="showDataDiv">
        ...
        <div id="frmRole">
            <sf:form method="post" modelAttribute="roleDto" id="frmUpdateRole" action="role/update">
                <sf:hidden path="id"></sf:hidden>
                <table cellspacing="0" cellPadding="0">
                    <thead>
                    <tr>
                        <td colspan="2">Update Role</td>
                    </tr>
                    </thead>
                    <tr>
                        <td class="rightTd" width="200px">Role Name:</td>
                        <td class="leftTd">
                            <sf:input path="name" size="30" id = "roleName"/>
                            <sf:errors cssClass="errorContainer" path="name"/></td>
                    </tr>
                    <tr>
                        <td class="rightTd">Description:</td>
                        <td class="leftTd">
                            <sf:input path="dec" size="30" id="description"/></td>
                    </tr>
                    <tr>
